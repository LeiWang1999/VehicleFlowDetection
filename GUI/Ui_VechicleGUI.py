...
"font-size:18px；")
        ...
        self.baseline_table.setColumnCount(3)
        ...
        self.baseline_table.horizontalHeader().setDefaultSectionSize(160)
        ...
        self.widget = QtWidgets.QWidget(self.baseline_info)
        self.widget.setGeometry(QtCore.QRect(0, 350, 501, 41))
        self.widget.setObjectName("widget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.baseline_message = QtWidgets.QLabel(self.widget)
...
"font-size:18px；")
        ...
        self.line_clear = QtWidgets.QPushButton(self.widget)
